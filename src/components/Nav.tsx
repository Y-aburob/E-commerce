            ...
            {(toggleMenu || isMdScreen)&&
                ...
                >
                    ...
                    <div className='flex flex-col gap-3 mt-20 font-bold md:flex-row md:mt-0 md:items-end'>
                        <Link className='p-4 text-base transition-all duration-300 text-DarkGrayishBlue lg:text-md hover:text-darkBlue' to="/404">Collections</Link>
                        <Link className='p-4 text-base transition-all duration-300 text-DarkGrayishBlue lg:text-md hover:text-darkBlue' to="/404">Men</Link>
                        <Link className='p-4 text-base transition-all duration-300 text-DarkGrayishBlue lg:text-md hover:text-darkBlue' to="/404">Women</Link>
                        <Link className='p-4 text-base transition-all duration-300 text-DarkGrayishBlue lg:text-md hover:text-darkBlue' to="/404">About</Link>
                        <Link className='p-4 text-base transition-all duration-300 text-DarkGrayishBlue lg:text-md hover:text-darkBlue' to="/404">Contact</Link>
                    </div>
